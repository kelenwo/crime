...
<div class="card mt-2">
  <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card">
<div class="card-top">
  <div class="m-3 mt-3 center text-white">
  <div class="round bg-danger mr-2" style="display:inline-block"><i class="fas fa-location-arrow"></i></div>
  <h5 style="display:inline-block">Confiscation</h5>
<hr>
  <span class="f-right">Engineering Market</span><br>
  <span class="f-right">12 May, 2020 @ 10:35am</span><br>
</div>
</div>
  <div class="card-body">
    ...
    <div class="col-md-6 col-sm-6 col-6"><button class="btn btn-outline-danger my-2 my-sm-0 btn-block">
      <strong>Delete</strong></button></div>
    </div>
  </div>
</div>
    </div>
